...
function AddCourseCategoryForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://kidgage-admin-cxde.onrender.com/api/course-category/add', formData, {
                headers: {
            ...
            {showForm && (
                <form className="add-course-form" onSubmit={handleSubmit}>
                    <div className="form-group add-course-label-group">
                        ...
                        <label htmlFor="file-upload">Image <span style={{ fontSize: '.8rem', color: 'grey' }}>[ size: 539 X 360 ]</span></label>
                    </div>
