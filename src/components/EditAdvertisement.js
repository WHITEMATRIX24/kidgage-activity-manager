...
const EditAdvertisementForm = () => {
    ...
    const fetchAdvertisements = async () => {
        try {
            const response = await axios.get('https://main.d3781xttwrodcq.amplifyapp.com/api/advertisement');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`https://main.d3781xttwrodcq.amplifyapp.com/api/advertisement/${editingAdvertisement._id}`, formData, {
                headers: {
    ...
    const confirmDelete = async () => {
        try {
            await axios.delete(`https://main.d3781xttwrodcq.amplifyapp.com/api/advertisement/${deletingAdvertisementId}`);
            fetchAdvertisements();
