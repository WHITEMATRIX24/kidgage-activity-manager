...
const EditAdvertisementForm = () => {
    ...
    const fetchAdvertisements = async () => {
        try {
            const response = await axios.get('https://kidgage-admin-rdld.onrender.com/api/advertisement');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`https://kidgage-admin-rdld.onrender.com/api/advertisement/${editingAdvertisement._id}`, formData, {
                headers: {
    ...
    const confirmDelete = async () => {
        try {
            await axios.delete(`https://kidgage-admin-rdld.onrender.com/api/advertisement/${deletingAdvertisementId}`);
            fetchAdvertisements();
