...
const EditBannerForm = () => {
    ...
    const fetchBanners = async () => {
        try {
            const response = await axios.get('https://main.d3781xttwrodcq.amplifyapp.com/api/banners');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`https://main.d3781xttwrodcq.amplifyapp.com/api/banners/${editingBanner._id}`, formData);
            fetchBanners();
    ...
    const confirmDelete = async () => {
        try {
            await axios.delete(`https://main.d3781xttwrodcq.amplifyapp.com/api/banners/${deletingBannerId}`);
            fetchBanners();
