...
const PromoteCourse = () => {
    ...
    useEffect(() => {
        const fetchProviders = async () => {
            try {
                const response = await axios.get('https://kidgage-admin-cxde.onrender.com/api/users/all'); // Adjust the URL as needed
    ...
    useEffect(() => {
        const fetchCourses = async () => {
            ...
            try {
                const response = await axios.get('https://kidgage-admin-cxde.onrender.com/api/courses/by-providers', {
                    params: { providerIds }
                });
    ...
    const handleConfirmPromotion = async () => {
        ...
        try {
            await axios.post(`https://kidgage-admin-cxde.onrender.com/api/promoted/promote/${selectedCourse._id}`, { promote: promoteMode });
