...
const EditPosterForm = ({ onDelete }) => {
    ...
    const fetchPosters = async () => {
        try {
            const response = await axios.get('https://kidgage-admin-eyau.onrender.com/api/posters');
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://kidgage-admin-eyau.onrender.com/api/posters/${selectedPoster._id}`, formData);
            setEditMode(false);
