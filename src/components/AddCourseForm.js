...
const removeImage = (index) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('https://kidgage-admin-cxde.onrender.com/api/courses/addcourse', formData, {
    ...
    const handleSearch = async () => {
        try {
            const response = await axios.get(`https://kidgage-admin-cxde.onrender.com/api/users/search?query=${searchQuery}`);
