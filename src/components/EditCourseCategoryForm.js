...
const EditCourseCategoryForm = () => {
    ...
    const handleConfirmDelete = async () => {
        try {
            await axios.delete(`https://kidgage-admin-eyau.onrender.com/api/course-category/delete/${bannerToDelete._id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://kidgage-admin-eyau.onrender.com/api/course-category/update/${selectedBanner._id}`, formData);
            setEditMode(false);
            setSelectedBanner(null);
            setFileName('No file chosen');
            setFile(null);
