...
const EditCourseForm = ({id}) => {
    ...
    const handleSearch = async (courseId) => {
        ...
        try {
            ...
            const response = await axios.get(`https://main.d3781xttwrodcq.amplifyapp.com/api/courses/course/${courseId}`);
            if (response.data) {
        ...
        if (isEditMode) {
            ...
            try {
                const response = await axios.put(
                    `https://main.d3781xttwrodcq.amplifyapp.com/api/courses/update/${courseData._id}`,
    ...
    const handleConfirmDelete = async () => {
        try {
            await axios.delete(`https://main.d3781xttwrodcq.amplifyapp.com/api/courses/delete/${courseData._id}`);
            setCourseData(null);
            setFormData({
                providerId: '',
                name: '',
