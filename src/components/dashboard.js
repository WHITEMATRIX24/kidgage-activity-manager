        ...
        if (itemToDelete) {
            try {
                if (deleteType === 'poster') {
                    await axios.delete(`https://main.d3781xttwrodcq.amplifyapp.com/api/posters/${itemToDelete._id}`);
                } else if (deleteType === 'student') {
                    await axios.delete(`https://main.d3781xttwrodcq.amplifyapp.com/api/student/delete/${itemToDelete._id}`);
                }
