        ...
        if (itemToDelete) {
            try {
                if (deleteType === 'poster') {
                    await axios.delete(`https://kidgage-admin-eyau.onrender.com/api/posters/${itemToDelete._id}`);
                } else if (deleteType === 'student') {
                    await axios.delete(`https://kidgage-admin-eyau.onrender.com/api/student/delete/${itemToDelete._id}`);
                }
